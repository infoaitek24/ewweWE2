...
import 'create_a_i_profile_new_model.dart';
export 'create_a_i_profile_new_model.dart';

class CreateAIProfileNewWidget extends StatefulWidget {
  const CreateAIProfileNewWidget({super.key});

  @override
  State<CreateAIProfileNewWidget> createState() =>
      _CreateAIProfileNewWidgetState();
}

class _CreateAIProfileNewWidgetState extends State<CreateAIProfileNewWidget> {
  late CreateAIProfileNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAIProfileNewModel());
