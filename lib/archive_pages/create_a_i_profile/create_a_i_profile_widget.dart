...
import 'create_a_i_profile_model.dart';
export 'create_a_i_profile_model.dart';

class CreateAIProfileWidget extends StatefulWidget {
  const CreateAIProfileWidget({super.key});

  @override
  State<CreateAIProfileWidget> createState() => _CreateAIProfileWidgetState();
}

class _CreateAIProfileWidgetState extends State<CreateAIProfileWidget> {
  late CreateAIProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAIProfileModel());
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            'Fill out your Assistants profiles below! Make it detailed so that your AI Assistant will respond depends on your preferences!',
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            'Fine tune your AI by playing with Task!',
                            style: FlutterFlowTheme.of(context).labelMedium,
                          ),
                        ],
                      ),
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              await dogsRecordReference
                                ...
                                dogType: _model.descriptionController.text,
                                dogAge: _model.dogAgeController.text,
                              ));
                              _model.aiProfile = DogsRecord.getDocumentFromData(
