...
import 'edit_a_i_profile_model.dart';
export 'edit_a_i_profile_model.dart';

class EditAIProfileWidget extends StatefulWidget {
  const EditAIProfileWidget({
    super.key,
    this.dogProfile,
  });
  ...
  @override
  State<EditAIProfileWidget> createState() => _EditAIProfileWidgetState();
}

class _EditAIProfileWidgetState extends State<EditAIProfileWidget> {
  late EditAIProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditAIProfileModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DogsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final editAIProfileDogsRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                'Fill out your dog profiles below! And then get to sharing!',
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                'Adding multiple assstant is coming soon.',
                                style: FlutterFlowTheme.of(context).labelMedium,
                              ),
                            ],
                          ),
