...
GoRouter createRouter(AppStateNotifier appStateNotifier, [Widget? entryPage]) =>
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'createAIProfile',
          path: '/createAIProfile',
          builder: (context, params) => const CreateAIProfileWidget(),
        ),
        FFRoute(
          name: 'createYourProfile',
          path: '/createYourProfile',
          builder: (context, params) => const CreateYourProfileWidget(),
        ),
        FFRoute(
          name: 'forgotPassword',
          path: '/forgotPassword',
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'main_Feed')
        ...
        FFRoute(
          ...
          builder: (context, params) => EditAIProfileWidget(
        ...
        FFRoute(
          name: 'createAIProfile_New',
          path: '/createAIProfileNew',
          builder: (context, params) => const CreateAIProfileNewWidget(),
        ),
        FFRoute(
          name: 'chat_2_Details',
          path: '/chat2Details',
        ...
        FFRoute(
          ...
          path: '/mainChat',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'main_Chat')
